        ...
        VStack(spacing: .zero) {
            VStack(alignment: .leading, spacing: .zero) {
                ...
                Link(
                    ...
                    destination: URL(string: "mailto:i.lozgkina@yandex.ru")!).tint(.ypBlueUniversal)//распаковка
            ...
            VStack(alignment: .leading, spacing: .zero) {
                ...
                Link("+7 (904) 329-27-71", destination: URL(string: "tel://+79043292771")!).tint(.ypBlueUniversal)//распаковка
                    .font(.system(size: 12, weight: .regular))
                    .frame(maxWidth: .infinity, alignment: .leading)
            }
            .padding(.vertical, 16)
